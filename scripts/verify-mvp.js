...
const requiredTerms = [
  ...
  ['api/README.md', ['GET /api/campaigns', 'POST /api/donations']],
  ['api/ai-impact-report.md', ['POST /api/proofs', 'trust_score']],
  ['api/certificates.md', ['POST /api/certificates', 'tx_hash']],
  ...
  ['be/handlers/donations.go', ['CreateDonation', 'ValidateDonationEvent']],
  ['be/handlers/proofs.go', ['CreateProof', 'analyzeProofWithAI']],
  ['be/handlers/certificates.go', ['CreateCertificate', 'UpdateCertificateTxHash']],
