...
const requiredFiles = [
  ...
  'be/db/migrations/003_storage_buckets.sql',
  'be/db/storage.md',
  'be/package.json',
  'be/package-lock.json',
  'be/self-check.js',
  'be/tsconfig.json',
  'be/src/runtime-self-check.ts',
  'be/src/adapters/web.ts',
...
const requiredTerms = [
  ...
  ['be/db/migrations/003_storage_buckets.sql', ['storage.buckets', 'campaign-covers', 'proofs', 'certificates', 'service-role only']],
  ['be/db/storage.md', ['Supabase Storage Plan', 'campaign-covers', 'proofs', 'certificates']],
  ['be/package.json', ['check', 'check:runtime', 'typecheck', '@supabase/supabase-js', 'ethers']],
  ['be/tsconfig.json', ['strict', 'outDir']],
  ['be/self-check.js', ['BE self-check passed', 'stableJsonHash']],
  ['be/src/runtime-self-check.ts', ['BE runtime self-check passed', 'MemoryDb', 'non-owner proof should be blocked']],
  ['be/src/adapters/web.ts', ['handleCreateCampaignRequest', 'handleCreateDonationRequest', 'handleImpactReportRequest', 'handleSignedUploadRequest']],
